                ...
                <div className='border-t-[1px] border-gray-400 py-8 grid grid-cols-3'>
                    ...
                    <div className='col-span-2 grid grid-cols-3'>
                        <div className='col-span-2 px-4 flex flex-col gap-1'>
                            ...
                            <h2 className='text-2xl font-semibold'>Google AI Ultra (45000 Credit VEO 3) 1 tháng - Tài khoản</h2>
                            <div className='flex gap-1 text-gray-500'>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 6.375c0 2.278-3.694 4.125-8.25 4.125S3.75 8.653 3.75 6.375m16.5 0c0-2.278-3.694-4.125-8.25-4.125S3.75 4.097 3.75 6.375m16.5 0v11.25c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125V6.375m16.5 0v3.75m-16.5-3.75v3.75m16.5 0v3.75C20.25 16.153 16.556 18 12 18s-8.25-1.847-8.25-4.125v-3.75m16.5 0c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125" />
                                </svg>
                                <p>Tình trạng: <span className='text-green-400'>Còn hàng</span></p>
                            </div>
                            <div className='flex gap-1 text-gray-500'>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75 22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3-4.5 16.5" />
                                </svg>
                                <p>Mã sản phẩm: <span className='text-black'>google-ai-ultra-1m</span></p>
                            </div>
                            <div className='flex gap-1 text-gray-500'>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M6 6.878V6a2.25 2.25 0 0 1 2.25-2.25h7.5A2.25 2.25 0 0 1 18 6v.878m-12 0c.235-.083.487-.128.75-.128h10.5c.263 0 .515.045.75.128m-12 0A2.25 2.25 0 0 0 4.5 9v.878m13.5-3A2.25 2.25 0 0 1 19.5 9v.878m0 0a2.246 2.246 0 0 0-.75-.128H5.25c-.263 0-.515.045-.75.128m15 0A2.25 2.25 0 0 1 21 12v6a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 18v-6c0-.98.626-1.813 1.5-2.122" />
                                </svg>
                                <p>Thể loại: <span className='text-blue-600'>App, AI, New, Gemini, Veo 3</span></p>
                            </div>
                            <div className='flex gap-1 items-center'>
                                <span className='text-2xl font-semibold'>199.000đ</span>
                            ...
                            <div className='flex gap-2 items-center py-2'>
                                <div className='text-gray-400 text-lg line-through'>6.500.000 đ</div>
                                <span className='px-2 py-1 text-white text-sm rounded-md bg-red-700'>-97%</span>
                            </div>
                            ...
                            <div className='py-3 border-t-[1px] border-gray-300 flex gap-2'>
                                <button
                                    ...
                                    hover:bg-white hover:text-blue-600 duration-300 cursor-pointer'
                                >
                                ...
                                <button
                                    ...
                                    flex gap-1 hover:bg-blue-600 hover:text-white duration-300 cursor-pointer'
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
